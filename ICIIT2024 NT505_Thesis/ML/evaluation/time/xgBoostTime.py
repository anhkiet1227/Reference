...
def detect_contract_type(token_ids, model_path, max_sequence_length=601):
    ...
    model_path (str): The path to the trained XGBoost model.
...
# Detect the contract type using XGBoost
model_path = '../bin/xgboost.joblib'  # Replace with the path to your trained XGBoost model
