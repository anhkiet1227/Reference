...
def detect_contract_type(token_ids, model_path, max_sequence_length=601):
    ...
    model_path (str): The path to the trained decision tree model.
...
model_path = '../bin/decision_tree.joblib'  # Replace with the path to your trained decision tree model
