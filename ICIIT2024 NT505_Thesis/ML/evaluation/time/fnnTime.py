...
def detect_contract_type(token_ids, model_path, max_sequence_length=601):
    ...
    model_path (str): The path to the trained feedforward neural network model.
...
# Detect the contract type using feedforward neural network
model_path = '../bin/fnn.h5'  # Replace with the path to your trained feedforward neural network model
